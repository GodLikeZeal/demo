package com.zeal.zealsay.auth.feign;


import com.zeal.zealsay.auth.feign.fallback.UserServiceFallbackImpl;
 ...
 * @date 2017/10/31
 */
@FeignClient(name = "pig-upms-smart", fallback = UserServiceFallbackImpl.class)
